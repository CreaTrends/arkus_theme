<?php
/**
 * Arkus functions and definitions
 *
...
if ( ! function_exists( 'arkus_setup' ) ) :
	/**
	 ...
	 */
	function arkus_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Arkus, use a find and replace
		 * to change 'arkus' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'arkus', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'arkus' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'arkus_custom_background_args', array(
 ...
 */
function arkus_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'arkus_content_width', 640 );
}
add_action( 'after_setup_theme', 'arkus_content_width', 0 );
 ...
 */
function arkus_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'arkus' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'arkus' ),
...
add_action( 'widgets_init', 'arkus_widgets_init' );
